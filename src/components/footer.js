...
function footer() {
  return (
    <>
      <footer className="footer">
        ...
        <div className="footer-content">
          ...
          <div className="footer-section">
            ...
            <ul>
              <li>
                <i className="fas fa-map-marker-alt"></i> New York, NY 10012, US
              </li>
              <li>
      ...
      {/* <footer
      className=" d-flex flex-wrap flex-direction-row justify-content-between align-items-center py-3 mt-auto border-top bg-grey" 
      style={{ color: 'dark' }}
